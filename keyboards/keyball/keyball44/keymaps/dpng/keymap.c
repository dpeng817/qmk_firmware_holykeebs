...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  ,        Z_UNDO   , KC_X     ,        C_COPY          , V_PSTE       ,  KC_B           ,                                        KC_N          , KC_M        , KC_COMM        , KC_DOT   , KC_SLSH  , KC_ENTER ,
                      KC_LALT  , KC_LCTL  ,        KC_LGUI         , KC_LCTL       , KC_BTN1        ,                                        KC_BSPC,        LT(2, KC_SPC),_______        , _______ , KC_PSCR
  ),
  ...
  [1] = LAYOUT_universal(
    ...
    KC_NO,        PERC_REDO,    KC_CIRC,    LCBR_URL,   KC_RCBR,       KC_TILD,             KC_MINS,        KC_1,          KC_2,    KC_3,    KC_0,     KC_ENTER,
                  KC_LGUI,      KC_LGUI,    KC_LGUI,    _______,       KC_BTN1,             KC_BSPC,        LT(2, KC_SPC),  _______, _______, KC_PSCR 
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    KC_NO,     KC_NO,       KC_NO,       KC_KB_VOLUME_DOWN,     KC_KB_MUTE,      KC_KB_VOLUME_UP	,     KC_NO,          KC_NO,       KC_NO,       KC_NO,      KC_NO,     KC_NO,
               KC_LGUI,     KC_LGUI,     KC_NO,                 _______,         _______,               KC_BSPC,        LT(2, KC_SPC),     _______    , _______  ,  KC_PSCR  
  ),
};
// clang-format on
